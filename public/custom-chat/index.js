$(function() {
	...
	function createOrJoinGeneralChannel(name) {
    name = name || "general"
		...
		chatClient
			...
			.catch(function() {
				...
				chatClient
					...
					.then(function(channel) {
						console.log(`Created ${name} channel:`);
						console.log(channel);
						generalChannel = channel;
						setupChannel();
					})
  ...
  // Set up channel after it has been found
	...
	var $addChannelBtn = $('#addChannelBtn');
	$addChannelBtn.on('click', function(e) {
    debugger;
    createOrJoinGeneralChannel(username)
	});
});
